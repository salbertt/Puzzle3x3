...
(defun resuelve ()
	(setq inicio  (read-array "C:\\Users\\Edgar\\Desktop\\Puzzle\\estadoInicial.txt" ) 
	meta (read-array "C:\\Users\\Edgar\\Desktop\\Puzzle\\estadoFinal.txt" )
	))
(resuelve)


(defvar *goal_node* meta)

(defvar *start_node* inicio)    ;;finds solution
...
(with-open-file (str "C:\\Users\\Edgar\\Desktop\\Puzzle\\data.txt"
                     :direction :output
                     :if-exists :supersede
...
;;function that executes the a-star algorithm using helper functions
	...
	(progn
		...
		(with-open-file (stream "C:\\Users\\Edgar\\Desktop\\Puzzle\\data.txt"
